          ...
          <template v-if="hasChildren(tr)">
            <tr
              ...
              >
                ...
                <div class="vrender cell" :class="td.tooltip ? 'el-tooltip' : ''" v-if="td.vRender">
                  <td-render :render="td.vRender" :row="childTr" :index="index" :column="td"></td-render>
                </div>
              </td>
            </tr>
          </template>
...
<script>
  ...
  import TdRender from './td-render.js';
  export default {
    name: 'ScTableExpand',
    props: {
      data: {
