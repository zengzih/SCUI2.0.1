              ...
              <tr>
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    style={this.setTdStyle(column, rowIndex === 0 && this.isCellHidden(cellIndex, columns))}
                    class={[column.leftBorder && !this.isCellHidden(cellIndex, columns) ? 'is_left_br' : '', column.rightBorder ? 'is_r_br' : '', !column.leftBorder ? 'no_left_br' : '', !column.rightBorder ? 'no_right_br' : '', column.id, column.order, column.headerAlign, column.className || '', rowIndex === 0 && this.isCellHidden(cellIndex, columns) ? 'is-hidden' : '', !column.children ? 'is-leaf' : '', column.labelClassName] }>
  ...
  methods: {
    ...
    setTdStyle(column, isHidden) {
      ...
      if (column.labelBgcolor) {
        var str = ';background:' + column.labelBgcolor + '!important;';
        vStyle += str;
      }
      return vStyle;
    },
