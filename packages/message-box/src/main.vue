      ...
      <div class="el-message-box" :class="customClass">
        <div class="el-message-box__header" v-if="title !== undefined">
          ...
          <button type="button" class="el-message-box__headerbtn" aria-label="Close"
            ...
            <i class="el-message-box__close el-icon-close" @click="canClose($event)"></i>
          </button>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleAction(action) {
        ...
        this.action = action;
        if (typeof this.beforeClose === 'function' && !this.closeEvent) {
          this.close = this.getSafeClose();
          this.beforeClose(action, this, this.close);
        } else if (typeof this.confirmClose === 'function' && this.closeEvent) {
          this.close = this.getSafeClose();
          this.confirmClose(action, this, this.close);
        } else {
          this.doClose();
        }
